...
public class Tank extends Actor
{
    ...
    public void followPath()
    {
    	...
    	if(nextPoint!=null)
    	{
	    	...
	    	else
	    	{
	    		...
	    		{
	    			System.out.println("x diff: "+(nextPoint.getX()-getX()));
	    			System.out.println("y diff: "+(nextPoint.getY()-getY()));
	    			System.out.println("tan2: "+(Math.atan2(nextPoint.getY()-
		    				getY(), nextPoint.getX()-getX())));
	    			System.out.println("in degrees: "+theta);
	    			System.out.println("normalized: "+normalizeAngle(theta));
	    		}
	...
	public LinkedList<GraphPoint> getPath()
	{
		return path;
	}
