...
public class GraphPoint implements Comparable<GraphPoint>
{
    ...
    {
    	int difference=this.getDistance()-otherPoint.getDistance();
    ...
    public static boolean isIntersectingWall(int x, int y, World world)
    {
    	...
    	{
    		/*for(WallBlock w: world.getObjectsAt(x+xOffset, y+yOffset, WallBlock.class))
    		{
    ...
    public static int getDistance(GraphPoint a, GraphPoint b)
    {
