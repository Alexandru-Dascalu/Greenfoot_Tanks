 ...
 * 
 * <p><b>Purpose: </b>
 * <p> This class models a target line for a Greenfoot recreation of the Wii Tanks 
 * game for the Nintendo Wii. It is a small segment of an interrupted line between
 * the player's turret and the player target. It moves when the player target and
 * the turret move and has the same rotation as the turret. There are a set number
 * of these actors, and the distance between each one increases when the distance 
 * between the player turret and the target.
 * 
 * <p><b>Version History</b>
 * <p>	-1.0 - Created the class.
 * <p>	-1.1 - Fixed a bug that would make the target lines be placed in the wrong
 * place if the game was reset inside Greenfoot.
 */

public class TargetLine extends Actor
{
	/**The number of target line actors that will form an interrupted line to
	 * the player target.*/
	public static final int NR_LINES=9;
	
	/**The player's turret. Static because all target lines need to be aligned 
	 * with this turret.*/
	private static PlayerTurret PLAYER_TURRET;
	
	/**The player's target. Static because all target lines need to be aligned 
	 * with this it.*/
	private static Target PLAYER_TARGET;
	
	/**The number of this object in the interrupted target line. Used to place
	 * each TargetLine actor in the right place.*/
	private final int number;
	
	/**
	 * Makes a new TargetLine actor for the turret and target given.
	 * @param playerTurret The player's turret that this TargetLine will be 
	 * aligned with.
	 * @param playerTarget The player's target that this TargetLine will be 
	 * aligned with.
	 * @param number The number of this TargetLine object in the line between
	 * the turret ad the target.
	 */
