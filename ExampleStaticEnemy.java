 ...
 */
public class ExampleStaticEnemy extends StaticEnemyTank
{
    /**
     * Makes a new ExampleStaticEnemy, with it's start x and y coordinates the ones given
     * as arguments.
     ...
     */
    public ExampleStaticEnemy(int startX, int startY, int startRotation)
    {
